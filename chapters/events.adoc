...
Unifly’s architecture centers around decoupled microservices and in
...
https://github.com/unifly/nakadi[Nakadi project], which acts as a
...
In Unifly's architecture, events are registered using a structure
  ...
  properties:
    ...
    audience:
      ...
      description: |
        ...
        in rule #219 -- see https://opensource.unifly.aero/restful-api-guidelines/#219
    owning_application:
      description: |
