...
----
{
  "self": "http://my-service.uniflyapis.aero/resources?cursor=<self-position>",
  "first": "http://my-service.uniflyapis.aero/resources?cursor=<first-position>",
  "prev": "http://my-service.uniflyapis.aero/resources?cursor=<previous-position>",
  "next": "http://my-service.uniflyapis.aero/resources?cursor=<next-position>",
  "last": "http://my-service.uniflyapis.aero/resources?cursor=<last-position>",
  "query": {
    "query-param-<1>": ...,
    "query-param-<n>": ...
  },
