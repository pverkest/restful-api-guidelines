...
:keywords: Unifly, Guidelines, RESTful, API, Events, Schema
...
= Unifly RESTful API and Event Scheme Guidelines
Unifly

image::assets/api-unifly-small.jpg[API Guild Logo]

Other formats: link:unifly-guidelines.pdf[PDF], link:unifly-guidelines.epub[EPUB3]
